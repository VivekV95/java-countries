...
class CountryList {
    ...
    fun findCountries(tester: CheckCountry): ArrayList<Country> {
        val tempCountryList = ArrayList<Country>()
        for (country in countryList) {
    ...
    /* fun findCountryName(tester: CheckCountry): String? {
        for (country in countryList) {
            if (tester.test(country)) {
                return country.name
            }
    ...
    fun findCountryNames(tester: CheckCountry): ArrayList<String> {
        val namesList = ArrayList<String>()
        for (country in countryList) {
            if (tester.test(country)) {
                namesList.add(country.name)
            }
        }
        return namesList
    }
